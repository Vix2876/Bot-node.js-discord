...
const client = new Client({
    ...
    const statuses = [
        { name: 'najlepszy serwer na świecie ', type: 1 }, // wstaw tu zaproszenie na serwer
        { name: 'najlepszy serwer na świecie ', type: 2 }, // wstaw tu zaproszenie na serwer
        { name: 'najlepszy serwer na świecie ', type: 3 }, // wstaw tu zaproszenie na serwer
        { name: 'najlepszy serwer na świecie ', type: 4 }, // wstaw tu zaproszenie na serwer
        { name: 'najlepszy serwer na świecie ', type: 5 }, // wstaw tu zaproszenie na serwer
       ];
